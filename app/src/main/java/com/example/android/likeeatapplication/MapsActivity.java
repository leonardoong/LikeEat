...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        //Toast.makeText(this, "Map siappp", Toast.LENGTH_SHORT).show();
        mMap = googleMap;
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback = new ResultCallback<PlaceBuffer>() {
        ...
        public void onResult(@NonNull PlaceBuffer places) {
            ...
            try{
                ...
                Log.d(TAG,"onResult: NullPoiterException " + e.getMessage());
            }

            moveCamera(new LatLng(place.getViewport().getCenter().latitude,
                    place.getViewport().getCenter().longitude), DEFAULT_ZOOM, mPlace.getName());
            places.release();
            Intent toPost = new Intent(MapsActivity.this, PostActivity.class);
            String alamat = mPlace.getAddress().toString();
            toPost.putExtra("Alamat", alamat);
